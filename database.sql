...
(911, 9, 31, 2, 'Слева от холла', 0, 0, 'каб 102/103/104/105', 912, true),
(912, 9, 31, 3, 'Вперед от холла', 0, 0, 'Гардероб, лестница на 2 этаж', 913, true),
(913, 9, 31, 4, 'Справа от гардероба', 0, 0, 'угол с каб 110', 914, true),
(9101, 9, 31, 2, 'Лестница 1', 0, 0, '', 9101, true),
(9102, 9, 31, 2, 'Лестница 2', 0, 0, '', 9102, true),
(920, 9, 32, 1, '2 этаж', 0, 0, '2 лестницы, деканат очного отделения', 921, true),
(921, 9, 32, 2, 'слева от лестниц', 0, 0, '2 лестницы, дека', 921, true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO edges (id, from_point_id, to_point_id, distance_meters, duration_minutes, direction_text, floor_transition, is_bidirectional) VALUES 
(1, 200, 201, 10, 0.3, 'К переходу в корпус 1', false, true),
(2, 200, 202, 15, 0.5, 'К центральной лестнице', false, true),
(3, 202, 203, 8, 0.2, 'Спуститься в главный коридор', false, true),
(4, 203, 204, 15, 0.5, 'Повернуть направо (восточное крыло)', false, true),
(5, 203, 205, 15, 0.5, 'Повернуть налево (западное крыло)', false, true),
(6, 204, 206, 20, 0.7, 'К лестнице в восточном крыле', false, true),
(7, 205, 207, 20, 0.7, 'К лестнице в западном крыле', false, true),
(8, 204, 208, 10, 0.3, 'В тупиковый коридор', false, true),
(9, 205, 209, 15, 0.5, 'К коридору столовой', false, true),
(10, 209, 210, 8, 0.2, 'В столовую', false, true),
(11, 202, 211, 8, 0.3, 'Подняться на 2 этаж (центральная лестница)', true, true),
(12, 206, 216, 8, 0.3, 'Подняться на 2 этаж (восточная лестница)', true, true),
(13, 207, 217, 8, 0.3, 'Подняться на 2 этаж (западная лестница)', true, true),
(14, 211, 212, 10, 0.3, 'В холл 2 этажа', false, true),
(15, 212, 213, 8, 0.2, 'В главный коридор', false, true),
(16, 213, 214, 15, 0.5, 'В восточное крыло', false, true),
(17, 213, 215, 15, 0.5, 'В западное крыло', false, true),
(18, 214, 218, 12, 0.4, 'К аудитории 201', false, true),
(19, 215, 219, 12, 0.4, 'К аудитории 215', false, true),
(20, 211, 220, 16, 0.6, 'Подняться на 3 этаж', true, true),
(21, 220, 221, 10, 0.3, 'В холл 3 этажа', false, true),
(22, 221, 222, 25, 0.8, 'К лаборатории биологии', false, true),
(23, 221, 223, 25, 0.8, 'К лаборатории ИИ', false, true)
ON CONFLICT (id) DO NOTHING;
