...
INSERT INTO edges (id, from_point_id, to_point_id, distance_meters, direction_text, floor_transition, is_bidirectional) 
VALUES 
(1, 200, 201, 10, 'К переходу в корпус 1', false, true), 
(2, 200, 202, 15, 'К центральной лестнице', false, true), 
(3, 202, 203, 8, 'Спуститься в главный коридор', false, true), 
(4, 203, 204, 15, 'Повернуть направо (восточное крыло)', false, true), 
(5, 203, 205, 15, 'Повернуть налево (западное крыло)', false, true), 
(6, 204, 206, 20, 'К лестнице в восточном крыле', false, true), 
(7, 205, 207, 20, 'К лестнице в западном крыле', false, true), 
(8, 204, 208, 10, 'В тупиковый коридор', false, true), 
(9, 205, 209, 15, 'К коридору столовой', false, true), 
(10, 209, 210, 8, 'В столовую', false, true), 
(11, 202, 211, 8, 'Подняться на 2 этаж (центральная лестница)', true, true), 
(12, 206, 216, 8, 'Подняться на 2 этаж (восточная лестница)', true, true), 
(13, 207, 217, 8, 'Подняться на 2 этаж (западная лестница)', true, true), 
(14, 211, 212, 10, 'В холл 2 этажа', false, true), 
(15, 212, 213, 8, 'В главный коридор', false, true), 
(16, 213, 214, 15, 'В восточное крыло', false, true), 
(17, 213, 215, 15, 'В западное крыло', false, true), 
(18, 214, 218, 12, 'К аудитории 201', false, true), 
(19, 215, 219, 12, 'К аудитории 215', false, true), 
(20, 211, 220, 16, 'Подняться на 3 этаж', true, true), 
(21, 220, 221, 10, 'В холл 3 этажа', false, true), 
(22, 221, 222, 25, 'К лаборатории биологии', false, true), 
(23, 221, 223, 25, 'К лаборатории ИИ', false, true) 
ON CONFLICT (id) DO NOTHING;
